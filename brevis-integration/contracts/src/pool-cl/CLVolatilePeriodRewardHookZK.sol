...
import "../framework/BrevisAppZkOnly.sol";
...
contract CLVolatilePeriodRewardHookZK is CLBaseHook, BrevisAppZkOnly, Ownable, ERC20 {
    using PoolIdLibrary for PoolKey;
    using BalanceDeltaLibrary for BalanceDelta;

    event VolatilityUpdated(uint256 m, uint256 s);
